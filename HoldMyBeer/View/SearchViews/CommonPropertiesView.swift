        ...
        VStack(alignment: .leading, spacing: 5) {
            HStack(alignment: .center, spacing: 20) {
                ...
                Toggle("Toggle", isOn: $common.toggle)
                    ...
                    .onChange(of: common.toggle) { newValue in
                        if newValue {
                            _ = URLBuilder.shared.addQueryItem(for: common.setInequality, common.value)
                        } else {
                            _ = URLBuilder.shared.removeQueryItem(for: common.setInequality)
                        }
                    }
            }
            ...
            if common.toggle {
                VStack(alignment: .center) {
                    ...
                    .onChange(of: common.inequality, perform: { _ in
                        _ = URLBuilder.shared.addQueryItem(for: common.setInequality, common.value)
                    })
